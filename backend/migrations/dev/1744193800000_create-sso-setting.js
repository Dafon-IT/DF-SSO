/**
 * 新增 sso_setting 通用設定表
 *
 * 首批 seed 為四組 rate limit 設定，對應原本寫死在 server.js 的
 * globalLimiter / authLimiter / sessionLimiter / exchangeLimiter。
 *
 * 採通用 key-value + jsonb，未來其他 runtime 可調參數可直接追加 seed，
 * 不需再改 schema。
 */
